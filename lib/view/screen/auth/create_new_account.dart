...
import 'package:coffee_shop_mobile_app/view/widget/custom_Button.dart';
import 'package:coffee_shop_mobile_app/view/widget/custom_textfield.dart';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 50),
                  TextButton(
                    onPressed: (){}, child: Text('Have an account'),),
